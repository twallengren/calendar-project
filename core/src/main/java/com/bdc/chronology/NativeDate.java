...
public record NativeDate(String chronologyId, int year, String monthCode, int day) {
  public NativeDate {
    ...
    if (monthCode.isBlank() || day < 1 || day > 31)
      throw new IllegalArgumentException("Invalid native date");
  }
}
