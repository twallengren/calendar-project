...
class CalendarDiffEngineTest {
    ...
    void futureAddition_returnsMinorSeverity() {
        ...
        List<Event> generated = List.of(
            new Event(LocalDate.of(2025, 1, 1), EventType.CLOSED, "New Year's Day", "test"),
            new Event(LocalDate.of(2027, 7, 4), EventType.CLOSED, "Independence Day", "test") // Future
        );
    ...
    void historicalAddition_returnsMajorSeverity() {
        ...
        List<Event> generated = List.of(
            new Event(LocalDate.of(2025, 1, 1), EventType.CLOSED, "New Year's Day", "test"),
            new Event(LocalDate.of(2024, 7, 4), EventType.CLOSED, "Independence Day", "test") // Historical
        );
    ...
    void modification_returnsMajorSeverity() {
        ...
        List<Event> generated = List.of(
            new Event(LocalDate.of(2025, 1, 1), EventType.NOTABLE, "New Year's Day (Modified)", "test")
        );
    ...
    void mixedChanges_returnsHighestSeverity() {
        ...
        List<Event> generated = List.of(
            ...
            new Event(LocalDate.of(2027, 12, 25), EventType.CLOSED, "Christmas", "test") // Future addition (MINOR)
        );
    ...
    void aggregateSeverity_returnsHighest() {
        CalendarDiff minor = new CalendarDiff("CAL1", DiffSeverity.MINOR, List.of(), List.of(), List.of(), cutoffDate);
        CalendarDiff none = new CalendarDiff("CAL2", DiffSeverity.NONE, List.of(), List.of(), List.of(), cutoffDate);
        CalendarDiff major = new CalendarDiff("CAL3", DiffSeverity.MAJOR, List.of(), List.of(), List.of(), cutoffDate);
