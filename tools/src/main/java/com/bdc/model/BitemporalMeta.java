 ...
 *
 * <p>Bitemporality refers to tracking two time dimensions: - Transaction Time: When we
 * recorded/knew this information - Valid Time: When this information is true in the real world
 *
 * <p>This enables: - Reproducibility: "What did we think the calendar looked like on date X?" -
 * Auditing: "When did we first know about holiday Y?" - Corrections: Add new data without losing
 * history
 */
