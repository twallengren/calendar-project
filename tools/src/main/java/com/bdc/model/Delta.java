...
public sealed interface Delta permits Delta.Add, Delta.Remove, Delta.Reclassify {
  ...
  record Add(String key, String name, LocalDate date, EventType classification) implements Delta {}

  record Remove(String key, LocalDate date) implements Delta {}

  record Reclassify(String key, LocalDate date, EventType newClassification) implements Delta {}
}
