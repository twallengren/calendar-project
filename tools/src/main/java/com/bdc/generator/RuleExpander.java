...
public class RuleExpander {
    ...
    private List<Occurrence> expandExplicitDates(Rule.ExplicitDates rule, DateRange range, String provenance) {
    ...
    private List<Occurrence> expandFixedMonthDay(Rule.FixedMonthDay rule, DateRange range, String provenance) {
        List<Occurrence> occurrences = new ArrayList<>();
    ...
    private List<Occurrence> expandNthWeekday(Rule.NthWeekdayOfMonth rule, DateRange range, String provenance) {
        List<Occurrence> occurrences = new ArrayList<>();
